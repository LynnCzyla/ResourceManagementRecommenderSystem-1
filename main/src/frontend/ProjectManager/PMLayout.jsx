    ...
    <div style={styles.layoutWrapper}>
      ...
      <aside style={{
        ...
        <nav style={styles.nav}>
          ...
          {/* Weekly Report */}
          <div
            onClick={() => handleNavClick('weekly-report')}
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'weekly-report' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'weekly-report' ? 'var(--color-primary)' : 'transparent',
            }}
            title="Weekly Report"
            className="hover-sidebar-item"
          >
            ...
            {!sidebarCollapsed && <span style={styles.navText}>Weekly Report</span>}
          </div>
