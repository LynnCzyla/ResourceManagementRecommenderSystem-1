...
import HRJobPostingsTab from './HRJobPostingsTab';
import HRApplicationsTab from './HRApplicationsTab';
import HRInterviewsTab from './HRInterviewsTab';
...
export default function HRLayout({ user, onLogout, isDark, toggleTheme }) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'dashboard':
        return <HRDashboardTab />;
      case 'job-postings':
        return <HRJobPostingsTab />;
      case 'applications':
        return <HRApplicationsTab />;
      case 'interviews':
        return <HRInterviewsTab />;
      case 'hired-employees':
        return <HRHiredEmployeesTab />;
      case 'resource-requests':
        return <HRResourceRequestsTab />;
      default:
        return <HRDashboardTab />;
    }
  };
    ...
    <div style={styles.layoutWrapper}>
      <aside style={{
        ...
        <nav style={styles.nav}>
          ...
          <div 
            onClick={() => handleNavClick('job-postings')} 
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'job-postings' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'job-postings' ? 'var(--color-primary)' : 'transparent',
            }}
            title="Job Postings"
            className="hover-sidebar-item"
          >
          ...
          <div 
            ...
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'applications' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'applications' ? 'var(--color-primary)' : 'transparent',
            }}
            title="Applications"
            className="hover-sidebar-item"
          >
            ...
            {!sidebarCollapsed && <span style={styles.navText}>Applications</span>}
          </div>
          ...
          <div 
            ...
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'interviews' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'interviews' ? 'var(--color-primary)' : 'transparent',
            }}
            title="Interviews"
            className="hover-sidebar-item"
          >
            ...
            {!sidebarCollapsed && <span style={styles.navText}>Interviews</span>}
          </div>

          <div 
            onClick={() => handleNavClick('hired-employees')} 
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'hired-employees' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'hired-employees' ? 'var(--color-primary)' : 'transparent',
            }}
          ...
          >
            ...
            {!sidebarCollapsed && <span style={styles.navText}>Hired Employees</span>}
          </div>

          <div 
            onClick={() => handleNavClick('resource-requests')} 
            style={{
              ...styles.navItem,
              backgroundColor: activeTab === 'resource-requests' ? 'var(--color-primary-light)' : 'transparent',
              borderLeftColor: activeTab === 'resource-requests' ? 'var(--color-primary)' : 'transparent',
            }}
                      ...
                      notifications.map(n => (
                        ...
                        >
                          <div style={styles.notifContent}>
                            ...
                            <span style={styles.notifTime}>{formatTime(n.created_at)}</span>
                          </div>
